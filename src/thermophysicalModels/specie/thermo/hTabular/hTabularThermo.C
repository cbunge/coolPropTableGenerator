...
{
    Hf_ *= this->W();
    cpTable = interpolation2DTable2<scalar>("constant/Cp");
    hTable = interpolation2DTable2<scalar>("constant/H");  
    cpTable.outOfBounds(interpolation2DTable2<scalar>::CLAMP);
    hTable.outOfBounds(interpolation2DTable2<scalar>::CLAMP); 
}
