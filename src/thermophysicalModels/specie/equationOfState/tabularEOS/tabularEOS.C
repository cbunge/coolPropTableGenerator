    ...
    Specie(is)
{
    ...
    densityTable = interpolation2DTable2<scalar>("constant/rho");
    CpMCvTable = interpolation2DTable2<scalar>("constant/CpMCv");
    densityTable.outOfBounds(interpolation2DTable2<scalar>::CLAMP);
    CpMCvTable.outOfBounds(interpolation2DTable2<scalar>::CLAMP);
}
...
:
    ...
    CpMCvTable(dict.subDict("equationOfState"))
{}
