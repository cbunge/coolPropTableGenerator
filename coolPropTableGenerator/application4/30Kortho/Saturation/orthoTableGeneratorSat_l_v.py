...
while p<pMax:  
    ...
    kappa_l[i][0] = ((CP.PropsSI('L','T',T,'Q',0,fluid_transport)-(0.25*CP.PropsSI('L','T',T,'Q',0,'REFPROP::parahydrogen')))*(1.3333333))
    kappa_v[i][0] =((CP.PropsSI('L','T',T,'Q',1,fluid_transport)-(0.25*CP.PropsSI('L','T',T,'Q',1,'REFPROP::parahydrogen')))*(1.3333333))
