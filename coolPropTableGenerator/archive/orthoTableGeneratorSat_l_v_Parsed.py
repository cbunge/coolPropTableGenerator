...
#print('Number of Temp Setpoints: '+ str(blockLen))
#print('Number of Blocks to be Parsed: '+ str(numBlocks))

print(Ts)


pSatFile = open("pSat","w")
#for i=1..18: create a list from j=1..18 and print to file
for i,p in enumerate(pRange):
    #sList = ["\t" + str(pSat[i][j]) + " " + str(Ts[i][j]) + " " + str(p) + "\n" for j in range(len(Ts[i]))]
    sList= ["\t" + str(Ts[i][i]) + " " + str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(mu_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(mu_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(rho_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(rho_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(Cp_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(Cp_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(kappa_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(kappa_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(CpMCv_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(CpMCv_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(H_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(H_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(E_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(E_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(S_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(S_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(c_l[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
...
for i,p in enumerate(pRange):
    ...
    sList = ["\t" + str(c_v[i][i]) + " " + str(Ts[i][i]) + " " +  str(p) + "\n"]
