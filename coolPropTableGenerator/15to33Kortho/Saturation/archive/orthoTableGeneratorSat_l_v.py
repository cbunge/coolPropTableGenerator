...
CP.set_reference_state('orthohydrogen',20.380069,35150.63737,1417.12332,0.036828) 
...
T0 = 15.0000 #Temperature start (K)
TMax = 32.0000 #Temperature end (K)
...
while T<TMax:      
    ...
    pSat[i].append(CP.PropsSI('P','T',T,'Q',0.5,fluid_thermo)) 
    ...
    c_l[i].append(CP.PropsSI('A','T',T,'Q',0.0000001,fluid_thermo))
    c_v[i].append(CP.PropsSI('A','T',T,'Q',0.9999999,fluid_thermo))
